    ...
    <main className='font-poppins flex w-full flex-col justify-between gap-12 pb-12'>
      ...
      <div className='flex w-full flex-col justify-center gap-8'>
        ...
        <div className='flex flex-col justify-center gap-4'>
          ...
          <div className='grid w-full grid-cols-[2fr,4fr] items-center justify-center gap-4'>
            Name
            <TextBox ref={name} textSize='small' placeholder='fullname' />
            Tel
            <TextBox ref={tel} textSize='small' placeholder='xxx-xxx-xxxx' />
            Guests
            <TextBox
              ref={guestNo}
              type='number'
      ...
      <FooterTemplate>
        <div className='flex items-center justify-between gap-4 px-4'>
          ...
          <Button label='Pay' variant='orange' onClick={handleClickPay} />
        </div>
      </FooterTemplate>
    </main>
  )
