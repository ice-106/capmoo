  ...
  return (
    <main className="font-poppins w-full">
      ...
      <div className='flex flex-row space-x-2'>
        <div className='w-auto px-2 mb-4 border-2 border-grey bg-[#D9D9D9] rounded-lg'>Status: Active</div>
      ...
      <section className="w-full flex flex-col gap-y-2">
          ...
          {mockReviewData.map((review, index) => (
            <ReviewCard key={index} 
              ...
              leftButton={<Button label="Respond" onClick={handleRespond} />}
              rightButton={<Button label="Report" onClick={handleReport} />}
            />
          ))}
        </section>
