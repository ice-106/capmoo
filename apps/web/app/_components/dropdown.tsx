...
const Dropdown = ({ selected, onSelect, defaultText, options }: DropdownProps) => {
    ...
    return (
        ...
        >
            ...
            {isOpen && (
                <div
                    className="absolute top-full left-0 w-full bg-white border-2 border-t-0 mt-1 rounded-lg z-10 max-h-32 overflow-y-auto"
                >
